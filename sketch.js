...
function setup() {
  ...
  rightWall = new Base(width - 100, height / 2 + 50, 800, 100, "#8d6e63", true);

  //bridge = new Base(15, { x:300, y: height / 2 + 50 });
  //jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);

  bridge = new Bridge(15, { x: width / 2 - 160, y: height / 2 - 10 });
  jointPoint = new Base(width / 2 - 160, height / 2 - 10, 40, 20, "#8d6e63", true);

  //bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  //jointPoint = new Bridge(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);

  bridge = new Bridge(20, { x: width / 2 - 300, y: height / 2 + 1 });
  jointPoint = new Bridge(width / 2 - 200, height / 2 + 10, 40, 20, "#8d6e63", true);
